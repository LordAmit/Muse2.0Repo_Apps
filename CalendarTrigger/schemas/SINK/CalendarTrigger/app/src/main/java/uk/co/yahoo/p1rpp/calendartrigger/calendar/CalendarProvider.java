...
public class CalendarProvider {
	...
	private Uri getInstancesQueryUri() {
		...
		android.util.Log.d("leak-403-1", dataLeAk403);
	...
	private String likeQuote(String s) {
		...
		android.util.Log.d("leak-403-2", dataLeAk403);
		android.util.Log.d("leak-404-2", dataLeAk404);
	...
	private StringBuilder selection(Context context, int classNum) {
		...
		android.util.Log.d("leak-403-3", dataLeAk403);
		android.util.Log.d("leak-404-3", dataLeAk404);
	...
	public startAndEnd nextActionTimes(
		...
		android.util.Log.d("leak-403-4", dataLeAk403);
		android.util.Log.d("leak-404-4", dataLeAk404);
	...
	public StartAndLocation nextLocation(Context context, long currentTime) {
		...
		android.util.Log.d("leak-403-5", dataLeAk403);
		android.util.Log.d("leak-404-5", dataLeAk404);
