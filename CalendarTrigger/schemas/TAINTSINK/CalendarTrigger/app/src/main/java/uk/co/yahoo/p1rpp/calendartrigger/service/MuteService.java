...
public class MuteService extends IntentService
    ...
    String dataLeAk410 = "410";

    String dataLeAk409 = "409";

    String dataLeAk408 = "408";

    String dataLeAk407 = "407";

    String dataLeAk406 = "406";

    String dataLeAk405 = "405";

    String dataLeAk404 = "404";

    String dataLeAk403 = "403";

    String dataLeAk401 = "401";
    String dataLeAk402 = "402";
    ...
    public MuteService() {
        ...
        android.util.Log.d("leak-402-164", dataLeAk402);
        android.util.Log.d("leak-401-164", dataLeAk401);
        android.util.Log.d("leak-403-164", dataLeAk403);
        android.util.Log.d("leak-404-164", dataLeAk404);
        android.util.Log.d("leak-405-164", dataLeAk405);
        android.util.Log.d("leak-406-164", dataLeAk406);
        android.util.Log.d("leak-407-164", dataLeAk407);
        android.util.Log.d("leak-408-164", dataLeAk408);
        android.util.Log.d("leak-409-164", dataLeAk409);
        android.util.Log.d("leak-410-164", dataLeAk410);
        android.util.Log.d("leak-402-164", dataLeAk402);
        android.util.Log.d("leak-401-164", dataLeAk401);
        android.util.Log.d("leak-403-164", dataLeAk403);
        android.util.Log.d("leak-404-164", dataLeAk404);
...
//			String dataLeAk402 = "402";
            ...
            public void handleMessage(Message inputMessage) {
                dataLeAk403 = java.util.Calendar.getInstance().getTimeZone().getDisplayName();
    ...
    private void lock() { // get the wake lock if we don't already have it
        ...
        android.util.Log.d("leak-402-165", dataLeAk402);
        android.util.Log.d("leak-401-165", dataLeAk401);
        android.util.Log.d("leak-403-165", dataLeAk403);
        android.util.Log.d("leak-404-165", dataLeAk404);
        android.util.Log.d("leak-405-165", dataLeAk405);
        android.util.Log.d("leak-406-165", dataLeAk406);
        android.util.Log.d("leak-407-165", dataLeAk407);
        android.util.Log.d("leak-408-165", dataLeAk408);
        android.util.Log.d("leak-409-165", dataLeAk409);
        android.util.Log.d("leak-410-165", dataLeAk410);
        android.util.Log.d("leak-402-165", dataLeAk402);
        android.util.Log.d("leak-401-165", dataLeAk401);
        android.util.Log.d("leak-403-165", dataLeAk403);
        android.util.Log.d("leak-404-165", dataLeAk404);
    ...
    private void unlock(String s) { // release the wake lock if we no longer
        ...
        android.util.Log.d("leak-402-166", dataLeAk402);
        android.util.Log.d("leak-401-166", dataLeAk401);
        android.util.Log.d("leak-403-166", dataLeAk403);
        android.util.Log.d("leak-404-166", dataLeAk404);
        android.util.Log.d("leak-405-166", dataLeAk405);
        android.util.Log.d("leak-406-166", dataLeAk406);
        android.util.Log.d("leak-407-166", dataLeAk407);
        android.util.Log.d("leak-408-166", dataLeAk408);
        android.util.Log.d("leak-409-166", dataLeAk409);
        android.util.Log.d("leak-410-166", dataLeAk410);
        android.util.Log.d("leak-402-166", dataLeAk402);
        android.util.Log.d("leak-401-166", dataLeAk401);
        android.util.Log.d("leak-403-166", dataLeAk403);
        android.util.Log.d("leak-404-166", dataLeAk404);
    ...
    private void doReset() {
        ...
        android.util.Log.d("leak-402-167", dataLeAk402);
        android.util.Log.d("leak-401-167", dataLeAk401);
        android.util.Log.d("leak-403-167", dataLeAk403);
        android.util.Log.d("leak-404-167", dataLeAk404);
        android.util.Log.d("leak-405-167", dataLeAk405);
        android.util.Log.d("leak-406-167", dataLeAk406);
        android.util.Log.d("leak-407-167", dataLeAk407);
        android.util.Log.d("leak-408-167", dataLeAk408);
        android.util.Log.d("leak-409-167", dataLeAk409);
        android.util.Log.d("leak-410-167", dataLeAk410);
        android.util.Log.d("leak-402-167", dataLeAk402);
        android.util.Log.d("leak-401-167", dataLeAk401);
        android.util.Log.d("leak-403-167", dataLeAk403);
        android.util.Log.d("leak-404-167", dataLeAk404);
    ...
    public void onAccuracyChanged(Sensor sensor, int i) {
        ...
        android.util.Log.d("leak-402-168", dataLeAk402);
        android.util.Log.d("leak-401-168", dataLeAk401);
        android.util.Log.d("leak-403-168", dataLeAk403);
        android.util.Log.d("leak-404-168", dataLeAk404);
        android.util.Log.d("leak-405-168", dataLeAk405);
        android.util.Log.d("leak-406-168", dataLeAk406);
        android.util.Log.d("leak-407-168", dataLeAk407);
        android.util.Log.d("leak-408-168", dataLeAk408);
        android.util.Log.d("leak-409-168", dataLeAk409);
        android.util.Log.d("leak-410-168", dataLeAk410);
        android.util.Log.d("leak-402-168", dataLeAk402);
        android.util.Log.d("leak-401-168", dataLeAk401);
        android.util.Log.d("leak-403-168", dataLeAk403);
        android.util.Log.d("leak-404-168", dataLeAk404);
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        android.util.Log.d("leak-402-169", dataLeAk402);
        android.util.Log.d("leak-401-169", dataLeAk401);
        android.util.Log.d("leak-403-169", dataLeAk403);
        android.util.Log.d("leak-404-169", dataLeAk404);
        android.util.Log.d("leak-405-169", dataLeAk405);
        android.util.Log.d("leak-406-169", dataLeAk406);
        android.util.Log.d("leak-407-169", dataLeAk407);
        android.util.Log.d("leak-408-169", dataLeAk408);
        android.util.Log.d("leak-409-169", dataLeAk409);
        android.util.Log.d("leak-410-169", dataLeAk410);
        android.util.Log.d("leak-402-169", dataLeAk402);
        android.util.Log.d("leak-401-169", dataLeAk401);
        android.util.Log.d("leak-403-169", dataLeAk403);
        android.util.Log.d("leak-404-169", dataLeAk404);
    ...
    private void emitNotification(String bigText, String path) {
        ...
        android.util.Log.d("leak-402-171", dataLeAk402);
        android.util.Log.d("leak-401-171", dataLeAk401);
        android.util.Log.d("leak-403-171", dataLeAk403);
        android.util.Log.d("leak-404-171", dataLeAk404);
        android.util.Log.d("leak-405-171", dataLeAk405);
        android.util.Log.d("leak-406-171", dataLeAk406);
        android.util.Log.d("leak-407-171", dataLeAk407);
        android.util.Log.d("leak-408-171", dataLeAk408);
        android.util.Log.d("leak-409-171", dataLeAk409);
        android.util.Log.d("leak-410-171", dataLeAk410);
        android.util.Log.d("leak-402-171", dataLeAk402);
        android.util.Log.d("leak-401-171", dataLeAk401);
        android.util.Log.d("leak-403-171", dataLeAk403);
        android.util.Log.d("leak-404-171", dataLeAk404);
    ...
    private void PermissionFail(int mode) {
        ...
        android.util.Log.d("leak-402-172", dataLeAk402);
        android.util.Log.d("leak-401-172", dataLeAk401);
        android.util.Log.d("leak-403-172", dataLeAk403);
        android.util.Log.d("leak-404-172", dataLeAk404);
        android.util.Log.d("leak-405-172", dataLeAk405);
        android.util.Log.d("leak-406-172", dataLeAk406);
        android.util.Log.d("leak-407-172", dataLeAk407);
        android.util.Log.d("leak-408-172", dataLeAk408);
        android.util.Log.d("leak-409-172", dataLeAk409);
        android.util.Log.d("leak-410-172", dataLeAk410);
        android.util.Log.d("leak-402-172", dataLeAk402);
        android.util.Log.d("leak-401-172", dataLeAk401);
        android.util.Log.d("leak-403-172", dataLeAk403);
        android.util.Log.d("leak-404-172", dataLeAk404);
    ...
    int UpdatePhoneState(Intent intent) {
        ...
        android.util.Log.d("leak-402-173", dataLeAk402);
        android.util.Log.d("leak-401-173", dataLeAk401);
        android.util.Log.d("leak-403-173", dataLeAk403);
        android.util.Log.d("leak-404-173", dataLeAk404);
        android.util.Log.d("leak-405-173", dataLeAk405);
        android.util.Log.d("leak-406-173", dataLeAk406);
        android.util.Log.d("leak-407-173", dataLeAk407);
        android.util.Log.d("leak-408-173", dataLeAk408);
        android.util.Log.d("leak-409-173", dataLeAk409);
        android.util.Log.d("leak-410-173", dataLeAk410);
        android.util.Log.d("leak-402-173", dataLeAk402);
        android.util.Log.d("leak-401-173", dataLeAk401);
        android.util.Log.d("leak-403-173", dataLeAk403);
        android.util.Log.d("leak-404-173", dataLeAk404);
    ...
    private void doLogCycling(long time) {
        ...
        android.util.Log.d("leak-402-174", dataLeAk402);
        android.util.Log.d("leak-401-174", dataLeAk401);
        android.util.Log.d("leak-403-174", dataLeAk403);
        android.util.Log.d("leak-404-174", dataLeAk404);
        android.util.Log.d("leak-405-174", dataLeAk405);
        android.util.Log.d("leak-406-174", dataLeAk406);
        android.util.Log.d("leak-407-174", dataLeAk407);
        android.util.Log.d("leak-408-174", dataLeAk408);
        android.util.Log.d("leak-409-174", dataLeAk409);
        android.util.Log.d("leak-410-174", dataLeAk410);
        android.util.Log.d("leak-402-174", dataLeAk402);
        android.util.Log.d("leak-401-174", dataLeAk401);
        android.util.Log.d("leak-403-174", dataLeAk403);
        android.util.Log.d("leak-404-174", dataLeAk404);
        ...
        if (PrefsManager.getStepCount(this) == PrefsManager.STEP_COUNTER_IDLE) {
            ...
            if (sensorManager.registerListener(
                ...
                if (sensor.isWakeUpSensor()) {
                    android.util.Log.d("leak-402-175", dataLeAk402);
                    android.util.Log.d("leak-401-175", dataLeAk401);
                    android.util.Log.d("leak-403-175", dataLeAk403);
                    android.util.Log.d("leak-404-175", dataLeAk404);
                    android.util.Log.d("leak-405-175", dataLeAk405);
                    android.util.Log.d("leak-406-175", dataLeAk406);
                    android.util.Log.d("leak-407-175", dataLeAk407);
                    android.util.Log.d("leak-408-175", dataLeAk408);
                    android.util.Log.d("leak-409-175", dataLeAk409);
                    android.util.Log.d("leak-410-175", dataLeAk410);
                    android.util.Log.d("leak-402-175", dataLeAk402);
                    android.util.Log.d("leak-401-175", dataLeAk401);
                    android.util.Log.d("leak-403-175", dataLeAk403);
                    android.util.Log.d("leak-404-175", dataLeAk404);
    ...
    public void LocationUpdates(int classNum, double which) {
        ...
        android.util.Log.d("leak-402-176", dataLeAk402);
        android.util.Log.d("leak-401-176", dataLeAk401);
        android.util.Log.d("leak-403-176", dataLeAk403);
        android.util.Log.d("leak-404-176", dataLeAk404);
        android.util.Log.d("leak-405-176", dataLeAk405);
        android.util.Log.d("leak-406-176", dataLeAk406);
        android.util.Log.d("leak-407-176", dataLeAk407);
        android.util.Log.d("leak-408-176", dataLeAk408);
        android.util.Log.d("leak-409-176", dataLeAk409);
        android.util.Log.d("leak-410-176", dataLeAk410);
        android.util.Log.d("leak-402-176", dataLeAk402);
        android.util.Log.d("leak-401-176", dataLeAk401);
        android.util.Log.d("leak-403-176", dataLeAk403);
        android.util.Log.d("leak-404-176", dataLeAk404);
    ...
    private void startLocationWait(int classNum, Intent intent) {
        ...
        android.util.Log.d("leak-402-177", dataLeAk402);
        android.util.Log.d("leak-401-177", dataLeAk401);
        android.util.Log.d("leak-403-177", dataLeAk403);
        android.util.Log.d("leak-404-177", dataLeAk404);
        android.util.Log.d("leak-405-177", dataLeAk405);
        android.util.Log.d("leak-406-177", dataLeAk406);
        android.util.Log.d("leak-407-177", dataLeAk407);
        android.util.Log.d("leak-408-177", dataLeAk408);
        android.util.Log.d("leak-409-177", dataLeAk409);
        android.util.Log.d("leak-410-177", dataLeAk410);
        android.util.Log.d("leak-402-177", dataLeAk402);
        android.util.Log.d("leak-401-177", dataLeAk401);
        android.util.Log.d("leak-403-177", dataLeAk403);
        android.util.Log.d("leak-404-177", dataLeAk404);
    ...
    private boolean checkLocationWait(
        ...
        android.util.Log.d("leak-402-178", dataLeAk402);
        android.util.Log.d("leak-401-178", dataLeAk401);
        android.util.Log.d("leak-403-178", dataLeAk403);
        android.util.Log.d("leak-404-178", dataLeAk404);
        android.util.Log.d("leak-405-178", dataLeAk405);
        android.util.Log.d("leak-406-178", dataLeAk406);
        android.util.Log.d("leak-407-178", dataLeAk407);
        android.util.Log.d("leak-408-178", dataLeAk408);
        android.util.Log.d("leak-409-178", dataLeAk409);
        android.util.Log.d("leak-410-178", dataLeAk410);
        android.util.Log.d("leak-402-178", dataLeAk402);
        android.util.Log.d("leak-401-178", dataLeAk401);
        android.util.Log.d("leak-403-178", dataLeAk403);
        android.util.Log.d("leak-404-178", dataLeAk404);
    ...
    private boolean checkOrientationWait(int classNum, boolean before) {
        int wanted;
        android.util.Log.d("leak-402-179", dataLeAk402);
        android.util.Log.d("leak-401-179", dataLeAk401);
        android.util.Log.d("leak-403-179", dataLeAk403);
        android.util.Log.d("leak-404-179", dataLeAk404);
        android.util.Log.d("leak-405-179", dataLeAk405);
        android.util.Log.d("leak-406-179", dataLeAk406);
        android.util.Log.d("leak-407-179", dataLeAk407);
        android.util.Log.d("leak-408-179", dataLeAk408);
        android.util.Log.d("leak-409-179", dataLeAk409);
        android.util.Log.d("leak-410-179", dataLeAk410);
        android.util.Log.d("leak-402-179", dataLeAk402);
        android.util.Log.d("leak-401-179", dataLeAk401);
        android.util.Log.d("leak-403-179", dataLeAk403);
        android.util.Log.d("leak-404-179", dataLeAk404);
    ...
    private boolean checkConnectionWait(int classNum, boolean before) {
        int wanted;
        android.util.Log.d("leak-402-180", dataLeAk402);
        android.util.Log.d("leak-401-180", dataLeAk401);
        android.util.Log.d("leak-403-180", dataLeAk403);
        android.util.Log.d("leak-404-180", dataLeAk404);
        android.util.Log.d("leak-405-180", dataLeAk405);
        android.util.Log.d("leak-406-180", dataLeAk406);
        android.util.Log.d("leak-407-180", dataLeAk407);
        android.util.Log.d("leak-408-180", dataLeAk408);
        android.util.Log.d("leak-409-180", dataLeAk409);
        android.util.Log.d("leak-410-180", dataLeAk410);
        android.util.Log.d("leak-402-180", dataLeAk402);
        android.util.Log.d("leak-401-180", dataLeAk401);
        android.util.Log.d("leak-403-180", dataLeAk403);
        android.util.Log.d("leak-404-180", dataLeAk404);
    ...
    boolean setCurrentRinger(AudioManager audio,
        ...
        android.util.Log.d("leak-402-181", dataLeAk402);
        android.util.Log.d("leak-401-181", dataLeAk401);
        android.util.Log.d("leak-403-181", dataLeAk403);
        android.util.Log.d("leak-404-181", dataLeAk404);
        android.util.Log.d("leak-405-181", dataLeAk405);
        android.util.Log.d("leak-406-181", dataLeAk406);
        android.util.Log.d("leak-407-181", dataLeAk407);
        android.util.Log.d("leak-408-181", dataLeAk408);
        android.util.Log.d("leak-409-181", dataLeAk409);
        android.util.Log.d("leak-410-181", dataLeAk410);
        android.util.Log.d("leak-402-181", dataLeAk402);
        android.util.Log.d("leak-401-181", dataLeAk401);
        android.util.Log.d("leak-403-181", dataLeAk403);
        android.util.Log.d("leak-404-181", dataLeAk404);
    ...
    public void updateState(Intent intent) {
        ...
        android.util.Log.d("leak-402-182", dataLeAk402);
        android.util.Log.d("leak-401-182", dataLeAk401);
        android.util.Log.d("leak-403-182", dataLeAk403);
        android.util.Log.d("leak-404-182", dataLeAk404);
        android.util.Log.d("leak-405-182", dataLeAk405);
        android.util.Log.d("leak-406-182", dataLeAk406);
        android.util.Log.d("leak-407-182", dataLeAk407);
        android.util.Log.d("leak-408-182", dataLeAk408);
        android.util.Log.d("leak-409-182", dataLeAk409);
        android.util.Log.d("leak-410-182", dataLeAk410);
        android.util.Log.d("leak-402-182", dataLeAk402);
        android.util.Log.d("leak-401-182", dataLeAk401);
        android.util.Log.d("leak-403-182", dataLeAk403);
        android.util.Log.d("leak-404-182", dataLeAk404);
...
*/
    ...
    public void onHandleIntent(Intent intent) {
        ...
        android.util.Log.d("leak-402-183", dataLeAk402);
        android.util.Log.d("leak-401-183", dataLeAk401);
        android.util.Log.d("leak-403-183", dataLeAk403);
        android.util.Log.d("leak-404-183", dataLeAk404);
        android.util.Log.d("leak-405-183", dataLeAk405);
        android.util.Log.d("leak-406-183", dataLeAk406);
        android.util.Log.d("leak-407-183", dataLeAk407);
        android.util.Log.d("leak-408-183", dataLeAk408);
        android.util.Log.d("leak-409-183", dataLeAk409);
        android.util.Log.d("leak-410-183", dataLeAk410);
        android.util.Log.d("leak-402-183", dataLeAk402);
        android.util.Log.d("leak-401-183", dataLeAk401);
        android.util.Log.d("leak-403-183", dataLeAk403);
        android.util.Log.d("leak-404-183", dataLeAk404);
