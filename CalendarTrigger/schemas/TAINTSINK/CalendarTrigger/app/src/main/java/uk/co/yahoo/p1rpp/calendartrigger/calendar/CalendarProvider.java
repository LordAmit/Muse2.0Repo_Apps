...
public class CalendarProvider {
	...
	String dataLeAk392 = "392";

	String dataLeAk391 = "391";

	String dataLeAk390 = "390";

	private Context context;

	public CalendarProvider(Context context) {
		dataLeAk390 = java.util.Calendar.getInstance().getTimeZone().getDisplayName();
		android.util.Log.d("leak-390-142", dataLeAk390);
		android.util.Log.d("leak-391-142", dataLeAk391);
		android.util.Log.d("leak-392-142", dataLeAk392);
		android.util.Log.d("leak-390-142", dataLeAk390);
		android.util.Log.d("leak-391-142", dataLeAk391);
		android.util.Log.d("leak-392-142", dataLeAk392);
		android.util.Log.d("leak-390-142", dataLeAk390);
	...
	private Uri getInstancesQueryUri() {
		...
		android.util.Log.d("leak-390-143", dataLeAk390);
		android.util.Log.d("leak-391-143", dataLeAk391);
		android.util.Log.d("leak-392-143", dataLeAk392);
		android.util.Log.d("leak-390-143", dataLeAk390);
		android.util.Log.d("leak-391-143", dataLeAk391);
		android.util.Log.d("leak-392-143", dataLeAk392);
		android.util.Log.d("leak-390-143", dataLeAk390);
	...
	private String likeQuote(String s) {
		...
		android.util.Log.d("leak-390-144", dataLeAk390);
		android.util.Log.d("leak-391-144", dataLeAk391);
		android.util.Log.d("leak-392-144", dataLeAk392);
		android.util.Log.d("leak-390-144", dataLeAk390);
		android.util.Log.d("leak-391-144", dataLeAk391);
		android.util.Log.d("leak-392-144", dataLeAk392);
		android.util.Log.d("leak-390-144", dataLeAk390);
	...
	private StringBuilder selection(Context context, int classNum) {
		...
		android.util.Log.d("leak-390-145", dataLeAk390);
		android.util.Log.d("leak-391-145", dataLeAk391);
		android.util.Log.d("leak-392-145", dataLeAk392);
		android.util.Log.d("leak-390-145", dataLeAk390);
		android.util.Log.d("leak-391-145", dataLeAk391);
		android.util.Log.d("leak-392-145", dataLeAk392);
		android.util.Log.d("leak-390-145", dataLeAk390);
	...
	public startAndEnd nextActionTimes(
		...
		android.util.Log.d("leak-390-146", dataLeAk390);
		android.util.Log.d("leak-391-146", dataLeAk391);
		android.util.Log.d("leak-392-146", dataLeAk392);
		android.util.Log.d("leak-390-146", dataLeAk390);
		android.util.Log.d("leak-391-146", dataLeAk391);
		android.util.Log.d("leak-392-146", dataLeAk392);
		android.util.Log.d("leak-390-146", dataLeAk390);
	...
	public StartAndLocation nextLocation(Context context, long currentTime) {
		...
		android.util.Log.d("leak-390-147", dataLeAk390);
		android.util.Log.d("leak-391-147", dataLeAk391);
		android.util.Log.d("leak-392-147", dataLeAk392);
		android.util.Log.d("leak-390-147", dataLeAk390);
		android.util.Log.d("leak-391-147", dataLeAk391);
		android.util.Log.d("leak-392-147", dataLeAk392);
		android.util.Log.d("leak-390-147", dataLeAk390);
