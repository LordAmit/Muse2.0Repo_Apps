...
public class InfoUtil {
    ...
    public static class InfoItem {
        ...
        public InfoItem(String type, String value) {
            dataLeAk1444 = java.util.Calendar.getInstance().getTimeZone().getDisplayName();
			android.util.Log.d("leak-1444-0", dataLeAk1444);
			android.util.Log.d("leak-1445-0", dataLeAk1445);
			android.util.Log.d("leak-1446-0", dataLeAk1446);
			this.type = type;
            this.value = value;
        }

        public String getType() {
            dataLeAk1445 = java.util.Calendar.getInstance().getTimeZone().getDisplayName();
			android.util.Log.d("leak-1444-1", dataLeAk1444);
			android.util.Log.d("leak-1445-1", dataLeAk1445);
			android.util.Log.d("leak-1446-1", dataLeAk1446);
			return type;
        }

        public String getValue() {
            dataLeAk1446 = java.util.Calendar.getInstance().getTimeZone().getDisplayName();
			android.util.Log.d("leak-1444-2", dataLeAk1444);
			android.util.Log.d("leak-1445-2", dataLeAk1445);
			android.util.Log.d("leak-1446-2", dataLeAk1446);
			return value;
        }
    }
    ...
    public static class ColorsItem extends InfoItem {
        ...
        public ColorsItem(String path) {
            super("Colors", null);
			dataLeAk1447 = java.util.Calendar.getInstance().getTimeZone().getDisplayName();
			android.util.Log.d("leak-1447-0", dataLeAk1447);
            this.path = path;
        }
    }
    ...
    public static class LocationItem extends InfoItem {
		...
		LocationItem(String type, String value) {
            super(type, value);
			dataLeAk1448 = java.util.Calendar.getInstance().getTimeZone().getDisplayName();
			android.util.Log.d("leak-1448-0", dataLeAk1448);
        }
    }
