...
public class SortUtil {
            ...
            case BY_SIZE:
                ...
                Collections.sort(albums, new Comparator<Album>() {
                    ...
                    public int compare(Album a1, Album a2) {
                        dataLeAk1442 = java.util.Calendar.getInstance().getTimeZone().getDisplayName();
						android.util.Log.d("leak-1442-0", dataLeAk1442);
						if (a1 != null && a2 != null) {
    ...
    public static void sortByDate(ArrayList<? extends Sortable> sortables) {
        ...
        Collections.sort(sortables, new Comparator<Sortable>() {
			...
			@Override
            public int compare(Sortable s1, Sortable s2) {
                dataLeAk1443 = java.util.Calendar.getInstance().getTimeZone().getDisplayName();
				android.util.Log.d("leak-1443-0", dataLeAk1443);
