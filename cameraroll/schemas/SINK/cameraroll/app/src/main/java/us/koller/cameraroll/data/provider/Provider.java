...
public abstract class Provider {
    ...
    void setCallback(Callback callback) {
		...
		android.util.Log.d("leak-259-1", dataLeAk259);
		android.util.Log.d("leak-260-1", dataLeAk260);
		android.util.Log.d("leak-261-1", dataLeAk261);
		android.util.Log.d("leak-262-1", dataLeAk262);
    ...
    public <T extends Callback> T getCallback() {
		...
		android.util.Log.d("leak-259-2", dataLeAk259);
		android.util.Log.d("leak-260-2", dataLeAk260);
		android.util.Log.d("leak-261-2", dataLeAk261);
		android.util.Log.d("leak-262-2", dataLeAk262);
		if (callback != null) {
            return (T) callback;
        }
        return null;
    ...
    public void onDestroy() {
		...
		android.util.Log.d("leak-259-3", dataLeAk259);
		android.util.Log.d("leak-260-3", dataLeAk260);
		android.util.Log.d("leak-261-3", dataLeAk261);
		android.util.Log.d("leak-262-3", dataLeAk262);
		setCallback(null);
