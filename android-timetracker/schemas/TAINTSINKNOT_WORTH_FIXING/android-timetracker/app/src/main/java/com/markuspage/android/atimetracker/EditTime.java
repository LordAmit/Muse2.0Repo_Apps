...
public class EditTime extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		android.util.Log.d("leak-97-118", dataLeAk97);
		android.util.Log.d("leak-98-118", dataLeAk98);
		android.util.Log.d("leak-99-118", dataLeAk99);
		android.util.Log.d("leak-100-118", dataLeAk100);
    ...
    protected void onResume() {
		...
		android.util.Log.d("leak-97-119", dataLeAk97);
		android.util.Log.d("leak-98-119", dataLeAk98);
		android.util.Log.d("leak-99-119", dataLeAk99);
		android.util.Log.d("leak-100-119", dataLeAk100);
    ...
    public void onClick(View v) {
		...
		android.util.Log.d("leak-97-120", dataLeAk97);
		android.util.Log.d("leak-98-120", dataLeAk98);
		android.util.Log.d("leak-99-120", dataLeAk99);
		android.util.Log.d("leak-100-120", dataLeAk100);
		DatePicker startDate = (DatePicker) findViewById(R.id.start_date);
        TimePicker startTime = (TimePicker) findViewById(R.id.start_time);
    ...
    protected Dialog onCreateDialog(int id) {
		...
		android.util.Log.d("leak-97-121", dataLeAk97);
		android.util.Log.d("leak-98-121", dataLeAk98);
		android.util.Log.d("leak-99-121", dataLeAk99);
		android.util.Log.d("leak-100-121", dataLeAk100);
