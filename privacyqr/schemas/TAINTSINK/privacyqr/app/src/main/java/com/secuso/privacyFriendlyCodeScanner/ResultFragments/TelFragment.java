...
public class TelFragment extends ResultFragment {
    ...
    public TelFragment() {
		...
		android.util.Log.d("leak-144-79", dataLeAk144);
		android.util.Log.d("leak-145-79", dataLeAk145);
		android.util.Log.d("leak-147-79", dataLeAk147);
		android.util.Log.d("leak-150-79", dataLeAk150);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		android.util.Log.d("leak-144-80", dataLeAk144);
		android.util.Log.d("leak-145-80", dataLeAk145);
		android.util.Log.d("leak-147-80", dataLeAk147);
		android.util.Log.d("leak-150-80", dataLeAk150);
